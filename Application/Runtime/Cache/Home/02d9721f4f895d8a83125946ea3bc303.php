...
<!--主体内容-->
    ...
    <div class="had-container" >
        <div class="news-center">
            <!--<a href="news.html"><img src="/Public/Images/newscenter.png" alt="新闻中心"></a>-->
        <span>&nbsp;&nbsp;
          <a class="bread-crumbs" href="news.html">  新闻中心</a>
            <span class="bread-crumbs">></span>
            <a class="bread-crumbs" href="news.html#companyNews">公司新闻</a>
        </span>
        </div>
        ...
        <p>
        </p><h3 style="text-align:center"><?php echo ($data[0]['title']); ?></h3>
